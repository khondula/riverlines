...
```{r}
gdalcommand <- glue::glue('gdalbuildvrt tmp/mosaic.vrt {glue_collapse(mask_files[1:300], sep = " ")}')
system(gdalcommand)
```
...
```{r}
gdalcommand <- glue::glue('gdalbuildvrt mosaic2.vrt {glue_collapse(mask_files[1:300], sep = " ")}')
system(gdalcommand)
